...
const PAY_CAPTION = [
  '💳 <b>Оплата Гала-ужина · Investment Forum 2026</b>',
  '',
  'Участие в форуме бесплатное. Этот QR — для оплаты праздничного Гала-ужина 29 июня (60 000 ₸, 12 мест).',
  '',
  'Отсканируйте QR-код в приложении <b>Halyk</b> или <b>Kaspi</b>.',
  '',
  'Получатель: <b>ИП АТОМ ЮНИТ</b> (г. Алматы)',
  '',
  '✅ После оплаты пришлите сюда <b>фото или скриншот чека</b> — мы подтвердим бронирование места.',
].join('\n');
