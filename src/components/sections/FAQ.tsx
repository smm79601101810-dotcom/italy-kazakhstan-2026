...
const faqs = [
  {
    ...
    a: 'Investment Forum пройдёт 11–12 июня 2026 года в Международном финансовом центре Астана (AIFC, Mangilik El 55/18). Два дня программы: пленарные сессии, B2B-встречи, подписание соглашений, гала-ужин 12 июня.',
  },
  {
    q: 'Что включено в тарифы?',
    a: 'Basic (€1.000) — участие, B2B-встречи, синхронный перевод, деловые обеды. Business — плюс гала-ужин и VIP-залы. Premium — плюс проживание и трансфер. VIP — максимальный пакет с двумя ночами в Rixos и персональным менеджером. Цены расширенных пакетов уточняются оргкомитетом.',
  },
  {
  ...
  },
  {
    ...
    a: 'Количество мест ограничено, приоритет отдаётся по порядку поступления заявок и подтверждению мэтчинга с казахстанскими операторами. Заявки принимаются до 24 апреля 2026 года.',
  },
  {
