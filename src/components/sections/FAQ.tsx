...
const faqs = [
  {
    ...
    a: 'Investment Forum пройдёт 29–30 июня 2026 года в Международном финансовом центре Астана (AIFC, Mangilik El 55/18). Два дня программы: пленарные сессии, B2B-встречи, подписание соглашений, гала-ужин 29 июня.',
  },
  {
    q: 'Сколько стоит участие?',
    a: 'Участие в форуме бесплатное для всех — нужно только зарегистрироваться через форму на сайте. В участие входят: пленарные сессии, программа B2B-встреч, круглые столы, деловые обеды, синхронный перевод и networking-приём. Единственная платная опция — праздничный Гала-ужин 29 июня (60 000 ₸, ограничено 12 мест).',
  },
  {
