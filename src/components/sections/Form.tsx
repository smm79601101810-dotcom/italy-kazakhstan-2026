          ...
          {submitted ? (
            ...
            >
              ...
              <p className="mx-auto mb-2 max-w-md text-ink/70">
                ...
                e-mail. Не пришёл или хотите быстрее — получите его в Telegram:
              </p>
              <a
                href="https://t.me/italkz_forum_bot?start=pay"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center gap-2 rounded bg-navy px-6 py-3.5 text-sm font-semibold uppercase tracking-[0.1em] text-cream transition-colors hover:bg-gold hover:text-navy-deep"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <label className="flex cursor-pointer items-start gap-3 border-l-[3px] border-gold bg-cream p-4 text-[13px] leading-relaxed text-ink/75">
                  ...
                  />
                  <span>
                    Подтверждаю принятие условий участия в Investment Forum: регистрационный взнос <strong>600 000 ₸</strong> по официальной форме CCIK, юрисдикция Суда Рима.
                  </span>
                </label>
                <label className="flex cursor-pointer items-start gap-3 border-l-[3px] border-gold bg-cream p-4 text-[13px] leading-relaxed text-ink/75">
                  <input
